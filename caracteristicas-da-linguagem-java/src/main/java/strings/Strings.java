...
public class Strings {
        ...
        public static void main(String[] args) {
            ...
            System.out.println("Nome do cliente : " + nome); // concatena
            System.out.println("Nome completo do cliente : " + nomeCompleto); //concatena
            var string = new String(" Minha  String ");

            System.out.println("Char na posição : " + string.charAt(5)); // encontra a char na posição indicada
            System.out.println("Quantidade=" + string.length()); // conta o tamanho da string
